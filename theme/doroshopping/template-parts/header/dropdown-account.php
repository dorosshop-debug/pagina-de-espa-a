...
<div class="header-dropdown header-dropdown--account" id="dropdown-account" hidden>
    ...
    <a href="<?php echo esc_url( wp_registration_url() ); ?>" class="header-dropdown__register"><?php esc_html_e( 'Registrate', 'doroshopping' ); ?></a>
    ...
    <ul class="header-dropdown__list header-dropdown__list--plain">
        <li><a href="#"><?php esc_html_e( 'Configuracion', 'doroshopping' ); ?></a></li>
        <li><a href="#"><?php esc_html_e( 'Mi perfil', 'doroshopping' ); ?></a></li>
        <li><a href="#"><?php esc_html_e( 'Metodos de pago', 'doroshopping' ); ?></a></li>
    </ul>

    <ul class="header-dropdown__list header-dropdown__list--footer">
        <li><a href="#"><?php esc_html_e( 'Centro de ayuda', 'doroshopping' ); ?></a></li>
        <li><a href="#"><?php esc_html_e( 'FAQ\'s - Preguntas Frecuentes', 'doroshopping' ); ?></a></li>
        <li><a href="#"><?php esc_html_e( 'Politica de devoluciones y reembolsos', 'doroshopping' ); ?></a></li>
        <li><a href="#"><?php esc_html_e( 'Politica de proteccion de datos personales', 'doroshopping' ); ?></a></li>
    </ul>
</div>
